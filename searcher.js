...
(function search() {
    ...
    function init(config) {
        ...
        // Use fzf for CJK search support if available
        if (window.fzf && window.fzf.Fzf) {
            const FzF = window.fzf.Fzf;
            const storeDocs = config.index.documentStore.docs;
            ...
            console.log('[fzf-search] CJK search support enabled');
        } else {
