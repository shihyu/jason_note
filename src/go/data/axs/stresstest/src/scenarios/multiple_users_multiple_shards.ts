...
import { getEnvConfig, EnvConfig, getRandomFloat, getRandomInt } from "../module/utils";
import { consumeBalanceChangeResults } from "../module/consumer";
import { Options } from 'k6/options';
import {  newRandBalanceChangeEvent } from '../types/balance_change_event';
...
export function invokeSubmitBalanceChangeEvents({ config }: { config: EnvConfig }) {
  ...
  const balanceChangeReq = newRandBalanceChangeEvent(1000, 6, -10000, 10000);
