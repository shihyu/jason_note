...
- [Tools 工具箱](tools/README.md)
    - [AI 與開發輔助工具](tools/01_AI與開發輔助工具.md)
        ...
        - [Claude Code Plugin 觸發機制完整說明](tools/trigger-mechanisms.md)
        ...
        - [skill-creator Go Skill 指揮稿（老闆下命令版）](tools/skill-creator-go-skill-prompts-boss.md)
...
- [Go 程式設計完整指南](go/README.md)
    ...
    - [🎯 cgo 完整指南：Go 與 C/C++ 互通實務](go/cgo_complete_guide.md)
    - [Go 基礎與模組管理](go/01_Go基礎與模組管理.md)
        - [Golang Note](go/note.md)
        - [Go 基礎](go/go.md)
        - [Python → Go 語法完整對照指南](go/python_vs_go.md)
    ...
    - [Runtime 與記憶體管理](go/03_Runtime與記憶體管理.md)
        ...
        - [Go、Rust 與 AWS 的成本取捨](go/go-rust-aws-cost-tradeoffs.md)
    ...
    - [Go 並發視覺化工具整理](go/go_concurrency_visualization_tools.md)
...
- [Linux System](linux_system/linux_system.md)
    ...
    - [Reverse Engineering CLI Tools](tools/reverse-engineering-tools-linux.md)
...
- [機器學習與深度學習完整指南](ml/README.md)
    - [機器學習基礎](ml/01_機器學習基礎.md)
        ...
        - [LoongFlow 與 OpenEvolve：從暴力進化到思考型代理](ml/loongflow-vs-openevolve-thinking-evolution-agent.md)
    ...
    - [深度學習與 PyTorch](ml/02_深度學習與PyTorch.md)
        ...
        - [Transformer 在交易策略中的應用](ml/transformer-trading-strategies.md)
        - [通俗易懂：白話講解 Transformer](ml/Transformer通俗講解.md)
...
- [策略文檔總覽](strategy/README.md)
    - [交易觀念與心法大全](strategy/01_交易觀念與心法大全.md)
        ...
        - [為什麼你總是在錯誤的地方重壓](strategy/為什麼你總是在錯誤的地方重壓.md)
        ...
        - [法人選股與資產配置策略指南](strategy/法人選股與資產配置策略指南.md)
        - [散戶 vs 大戶：思維差異與選股心法](strategy/散戶vs大戶思維與選股心法.md)
        - [股票交易口訣整理](strategy/stock-trading-notes.md)
        - [成交量口訣：縮量心法六式](strategy/成交量口訣_縮量心法六式.md)
    ...
    - [台股ETF槓桿策略](strategy/08_台股ETF槓桿策略.md)
        ...
        - [勳仔指數節稅多元收益投資法](strategy/勳仔_指數節稅多元收益投資法.md)
...
- [AI Agent 自主系統開發](ai_agent/ai_agent.md)
    ...
    - [Autonomous Dev Team 使用指南](ai_agent/autonomous-dev-team-usage_zh-TW.md)
    ...
    - [Harness / MCP / Skills / CLI 重點整理](ai_agent/harness_mcp_skills_cli_summary.md)
    ...
    - [Claude Code 三大核心概念：Subagents、Commands、Skills 完整指南](ai_agent/claude-code-core-concepts.md)
    - [AI 寫程式的終極悖論：你越依賴它，越需要人類思考](ai_agent/ai-coding-paradox-rpi.md)
    - [我錯了，還是要讀程式碼：Dex Horthy 重新檢討 RPI（CRISPY 工作流）](ai_agent/rpi-to-crispy-workflow.md)
    ...
    - [NVIDIA NIM API 申請教學](ai_agent/nvidia-nim-api-guide.md)
