...
- [高頻低延遲 Linux 完整配置指南](02-system/高頻低延遲Linux完整配置指南.md) - 硬體 + 系統 + 程式碼極致優化，涵蓋 BIOS、GRUB、DPDK 與 C++ 實踐
...
- [HFT 開發完整指南](06-resources/hft-dev-complete-guide.md) - 開發環境、編譯策略、效能測量、系統調優、部署實踐
- [低延遲技術最佳實踐指南](06-resources/低延遲技術最佳實踐指南.md) - 延遲測量、資料結構、記憶體管理、執行緒管理、網路優化、硬體調優完整指南
...
2. [HFT 開發完整指南](06-resources/hft-dev-complete-guide.md) ← **實務開發必讀**
3. [語言分層架構](01-language/language-layers.md)
4. [OS 選擇指南](02-system/os-selection.md)
...
### 重點推薦檔案
- 🔥 [HFT 開發完整指南](06-resources/hft-dev-complete-guide.md) - 從開發環境到生產部署的完整實務指南
