...
以下章節是對 eBPF 的快速介紹。如果您想了解更多關於 eBPF 的資訊，請參閱 eBPF & XDP 參考指南。無論您是希望構建 eBPF 程式的開發人員，還是對該技術本身更感興趣，瞭解基本概念和架構都是有用的。
...
- 在不幹預應用程式或容器的情況下啟用基礎設施軟體：eBPF 程式在作業系統內部工作，允許保證任何應用程式的完全透明度。
