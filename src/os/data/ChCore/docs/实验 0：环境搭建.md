...
- VirtualBox 虛擬機
    - [交大雲盤](https://jbox.sjtu.edu.cn/l/K1XVOu)，提取密碼：`os2022`，大小：6.94GB，MD5：c25f9064863e5e6d2be4aa30d41f92a8）
    - 你需要先安裝 VirtualBox，然後導入我們已經配置好的虛擬機
- VMware 虛擬機
    - [交大雲盤](https://jbox.sjtu.edu.cn/l/N15u1n)，提取密碼：`os2022`，大小：4.55GB，MD5：6c6f30518a6562080e92bbf0db05d8f5
...
登錄你的 Gitlab 後，打開 <https://ipads.se.sjtu.edu.cn:2020/os-2022/chcore-lab> 來 fork 一份 ChCore 倉庫代碼副本到你自己的賬戶下。之後，你可以對你賬戶下的 ChCore 倉庫代碼進行任意修改和提交，而不會對原 ChCore 倉庫產生影響。
...
- 原倉庫（upstream）：助教發佈實驗代碼的倉庫，也是被 fork 出來的倉庫
