...
1. `main` 函数是程序的入口，首先 `main` 函数的栈帧被创建。
   ...
   <img src="images/202205032036717.png"  height = "350" alt="图片名称" align=center />

2. 当 `main` 函数调用 `add1` 时，一个新的栈帧被创建用来保存 `add1` 函数的数据。栈顶指针被修改为新栈的顶部。

   <img src="images/202205032039168.png"  height = "350" alt="图片名称" align=center />
...
3. 函数调用结束
   ...
   <img src="images/202205032040616.png"  height = "350" alt="图片名称" align=center />
...
<img src="images/202205032154186.png"  height = "400" alt="图片名称" align=center />
...
<img src="images/202205032155624.png"  height = "400" alt="图片名称" align=center />
...
<img src="images/202205032243927.png"  height = "400" alt="图片名称" align=center />
