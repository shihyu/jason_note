...
<li><a href="DEFAULT_MESSAGE_ID.html">DEFAULT_MESSAGE_ID</a></li></ul>
<h1>Variable DEFAULT_MESSAGE_ID<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature">DEFAULT_<wbr/>MESSAGE_<wbr/>ID<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">1</span><span class="tsd-signature-symbol"> = 1</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/buttplugio/buttplug-js/blob/d899bf9/src/core/Messages.ts#L16">src/core/Messages.ts:16</a></li></ul></aside></div>
