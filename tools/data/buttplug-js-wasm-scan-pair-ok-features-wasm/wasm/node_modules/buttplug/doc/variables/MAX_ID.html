...
<li><a href="MAX_ID.html">MAX_ID</a></li></ul>
<h1>Variable MAX_ID<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature">MAX_<wbr/>ID<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">4294967295</span><span class="tsd-signature-symbol"> = 4294967295</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/buttplugio/buttplug-js/blob/d899bf9/src/core/Messages.ts#L17">src/core/Messages.ts:17</a></li></ul></aside></div>
...
<li class="current tsd-kind-variable"><a href="MAX_ID.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-32-path"></use><use href="#icon-32-text"></use></svg>MAX_<wbr/>ID</a></li>
